...
export const myOrders = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get('http://localhost:8081/api/v1/orders/my-orders');
...
export const getAllOrders = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get('http://localhost:8081/api/v1/orders');
...
export const updateOrder = (id, order) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`http://localhost:8081/api/v1/orders/${id}`, order, config);
...
export const getOrderDetails = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`http://localhost:8081/api/v1/orders/${id}`);
